...
- **未来世界**——曾影响一代玩家与开发者的经典游戏模式；
- **兰草乡村（最初 Dylan 时期版本）**——风格独树一帜的乡村题材经典，其早期版本尤其深入人心；
- **PRace**——影响深远的开源赛道系统，赛道数据与竞速玩法的重要源头；
- **PHouse**——开源房屋系统，房屋物件数据的重要来源。

同时也向 **open.mp 社区**以及所有默默奉献的开源脚本、插件与工具作者致以谢意——正是开放的生态，让自研与重构成为可能。文中未能一一列举的贡献者还有很多，你们的每一份代码都在影响着后来者。
